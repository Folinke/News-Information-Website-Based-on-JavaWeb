...
(function (j, C) {
    ...
    function L(a, b) {
        var c = this.chart, d = this.options.animation, g = this.group, f = this.markerGroup, e = this.xAxis.center,
            i = c.plotLeft, n = c.plotTop;
        if (c.polar) {
    ...
    var P = j.arrayMin, Q = j.arrayMax, s = j.each, F = j.extend, p = j.merge, R = j.map, r = j.pick, v = j.pInt,
        m = j.getOptions().plotOptions, h = j.seriesTypes, x = j.extendClass, M = j.splat, o = j.wrap, N = j.Axis,
        u = j.Tick, z = j.Series, q = h.column.prototype, t = Math, D = t.round, A = t.floor, S = t.max,
        w = function () {
        };
    F(J.prototype, {
        init: function (a, b, c) {
    ...
    var G = N.prototype, u = u.prototype, T = {
        ...
        getPlotBandPath: function (a, b, c) {
            var d = this.center, g = this.startAngleRad, f = d[2] / 2,
                e = [r(c.outerRadius, "100%"), c.innerRadius, r(c.thickness, 10)], i = /%$/, n, l = this.isCircular;
    ...
    o(u, "getLabelPosition", function (a, b, c, d, g, f, e, i, n) {
        var l = this.axis, k = f.y, h = f.align,
    ...
    h.arearange = j.extendClass(h.area, {
        type: "arearange", pointArrayMap: ["low", "high"], toYData: function (a) {
            ...
            var a = this.data, b = a.length, c, d = [], g = z.prototype, f = this.options.dataLabels, e,
        ...
        type: "gauge", pointClass: j.extendClass(j.Point, {
            ...
            s(this.points, function (d) {
                var g = p(b.dial, d.dial), f =
                        v(r(g.radius, 80)) * c[2] / 200, e = v(r(g.baseLength, 70)) * f / 100,
                    i = v(r(g.rearLength, 10)) * f / 100, n = g.baseWidth || 3, l = g.topWidth || 1,
    ...
    h.boxplot = x(h.column, {
        ...
        drawPoints: function () {
            var a = this, b = a.points, c = a.options, d = a.chart.renderer, g, f, e, i, n, l, k, h, j, m, o, H, p, E,
                I, q, w, t, v, u, z, y, x = a.doQuartiles !==
    ...
    h.waterfall = x(h.column, {
        type: "waterfall", upColorProp: "fill", pointArrayMap: ["low", "y"], pointValKey: "y", init: function (a, b) {
            ...
            var a = this.options, b = a.states, c = a.upColor || this.color, a = j.Color(c).brighten(0.1).get(),
                d = p(this.pointAttr), g = this.upColorProp;
            d[""][g] = c;
            ...
            var a = this.data, b = a.length, c = D(this.options.lineWidth + this.options.borderWidth) % 2 / 2, d = [],
                g, f, e;
    ...
    N.prototype.beforePadding = function () {
        var a = this, b = this.len, c = this.chart, d = 0, g = b, f = this.isXAxis,
            e = f ? "xData" : "yData", i = this.min, h = {}, j = t.min(c.plotWidth, c.plotHeight), k = Number.MAX_VALUE,
            m = -Number.MAX_VALUE, o = this.max - i, p = b / o, q = [];
