    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">新增公告信息</div>
          <div class="layui-card-body">
             <form action="BoardServlet?action=addBoard" method="post" id="registerForm" name="registerForm" enctype="multipart/form-data" class="layui-form">
