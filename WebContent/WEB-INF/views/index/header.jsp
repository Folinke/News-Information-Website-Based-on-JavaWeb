...
<div class="page-wrapper">
            ...
            <nav class="navigation navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="IndexServlet?action=toIndex">新闻网站220162401006 冯娈贻</a>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse navigation-holder">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children">
                                <a href="IndexServlet?action=toFankui">用户反馈</a>
                            </li>
                            <c:if test="${user != null }">
                                <li class="menu-item-has-children">
                                    <a href="LoginServlet?action=toMain">我的后台</a>
                                </li>
                            </c:if>
                            <c:if test="${user != null }">
    ...
    <section class="hero hero-style-2">
        <div class="hero-slider">
            ...
            <div class="slide">
                <div class="container">
                    <img src="assets/images/slider/slide-6.png" alt class="slider-bg">
                    <div class="row">
                        <div class="col col-md-8 slide-caption">
                            <div class="slide-title">
                                <h2>欢迎来到新闻网站</h2>
            ...
            <div class="slide">
                <div class="container">
                    <img src="assets/images/slider/slide-7.png" alt class="slider-bg">
                    <div class="row">
                        <div class="col col-md-8 slide-caption">
                            <div class="slide-title">
                                <h2>欢迎来到新闻网站</h2>
