    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">新增反馈信息</div>
          <div class="layui-card-body">
             <form action="FankuiServlet?action=addFankui" method="post" class="layui-form">
              <div class="layui-form-item">
                <label class="layui-form-label">标题:</label>
                <div class="layui-input-inline">
				<input type="text" name="titles"  class="layui-input" />
                </div>
              </div>
              ...
              <br>
                ...
                <div class="layui-input-block">
                  ...
                  <a href="FankuiServlet?action=toAddFankui" class="layui-btn layui-btn-primary" >重置</a>
                </div>
              </div>  
              </form>
            </div>
