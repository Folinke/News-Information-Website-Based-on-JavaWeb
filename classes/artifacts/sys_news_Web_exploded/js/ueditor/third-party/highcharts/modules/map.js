...
(function (g) {
    ...
    var r = g.Axis, y = g.Chart, s = g.Point, z = g.Pointer, l = g.each, v = g.extend, p = g.merge, n = g.pick,
        A = g.numberFormat, B = g.getOptions(), k = g.seriesTypes, q = B.plotOptions, t = g.wrap, u = g.Color,
        w = function () {
        };
    B.mapNavigation = {
        buttonOptions: {
    ...
    g.splitPath = function (a) {
        var b, a = a.replace(/([A-Za-z])/g, " $1 "), a = a.replace(/^\s*/, "").replace(/\s*$/, ""),
            a = a.split(/[ ,]+/);
    ...
    v(y.prototype, {
        renderMapNavigation: function () {
            ...
            if (!this.isMapZooming) {
                var d = this, e = d.xAxis[0], f = e.max - e.min, i = n(b, e.min + f / 2), b = f * a, f = d.yAxis[0],
                    h = f.max - f.min, c = n(c, f.min + h / 2);
                a *= h;
                i -= b / 2;
                h = c - a / 2;
    ...
    r = g.extendClass(s, {
        applyOptions: function (a, b) {
            ...
            var a = this, b = +new Date, c = u(a.options.color), d = u(a.pointAttr.hover.fill),
                e = a.series.options.states.normal.animation, f = e && (e.duration || 500);
    ...
    k.map = g.extendClass(k.scatter,
        {
            ...
            drawLegendSymbolGradient: function (a, b) {
                var c = a.options.symbolPadding, d = n(a.options.padding, 8), e, f,
                    i = this.chart.renderer.fontMetrics(a.options.itemStyle.fontSize).h,
                    h = a.options.layout === "horizontal", j;
            ...
            drawPoints: function () {
                ...
                l(this.data, function (d) {
                    var e = d.dataLabels, f = a.toPixels(d._minX, !0), g = a.toPixels(d._maxX, !0),
                        h = b.toPixels(d._minY, !0), j = b.toPixels(d._maxY, !0);
            ...
            animateDrilldown: function (a) {
                var b = this.chart.plotBox,
                    c = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1], d = c.bBox,
